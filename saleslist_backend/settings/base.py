...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "saleslist_backend.pagination.DefaultPageNumberPagination",
    "PAGE_SIZE": 50,
...
CELERY_BEAT_SCHEDULE = {
    "sync-facebook-activity": {
        ...
        "schedule": crontab(hour=2, minute=0, tz="Asia/Tokyo"),
    },
    "run-ai-enrich": {
        "task": "ai_enrichment.tasks.run_ai_enrich",
        "schedule": crontab(hour=3, minute=0, tz="Asia/Tokyo"),
    },
}
