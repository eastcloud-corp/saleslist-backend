#!/usr/bin/env python
"""
クライアントデータに企業情報を追加するスクリプト
Djangoシェルから実行: python manage.py shell < update_client_data.py
または: python manage.py shell
>>> exec(open('update_client_data.py').read())
"""
import os
import django

# Django設定を読み込む
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'saleslist_backend.settings.dev')
django.setup()
